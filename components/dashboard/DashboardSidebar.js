                ...
                {item.subItems ? (
                  <>
                    <button
                      ...
                      className={`flex items-center justify-between w-full px-4 py-3 rounded-lg transition-colors duration-200 ${pathname.startsWith(item.href)
                    ...
                    >
                      ...
                      <svg
                        className={`w-4 h-4 transition-transform duration-200 ${expandedSections[item.name] ? 'rotate-180' : ''
                          }`}
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                        ...
                        {item.subItems.map((subItem) => (
                          <li key={subItem.name}>
                            <Link
                              ...
                              className={`flex items-center space-x-3 px-3 py-2 rounded-md transition-colors duration-200 ${isActive(subItem.href)
